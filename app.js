...
const paletteGalleryContainer = document.querySelector(".js-gallery");
...
paletteGalleryContainer.insertAdjacentHTML("beforeend", cardsGallery);

paletteGalleryContainer.addEventListener("click", onPaletteGalleryContainer);
